...
public interface MyConstants {
    ...
    public static final String ASSIGN_PROFESSOR_PATH = SLASH + "student" + SLASH + "{" + STUDENT_ID_ELEMENT + "}" + SLASH + "course" + SLASH + "{" + COURSE_ID_ELEMENT + "}" + SLASH + "professor" + SLASH + "{" + PROFESSOR_ID_ELEMENT + "}";
    public static final String ASSIGN_GRADE_PATH = SLASH + "student" + SLASH + "{" + STUDENT_ID_ELEMENT + "}" + SLASH + "course" + SLASH + "{" + COURSE_ID_ELEMENT + "}" + SLASH + "grade" + SLASH + "{" + GRADE_ELEMENT + "}";
    public static final String COURSE_REGISTRATION_BY_IDS_PATH = SLASH + "student" + SLASH + "{" + STUDENT_ID_ELEMENT + "}" + SLASH + "course" + SLASH + "{" + COURSE_ID_ELEMENT + "}";
    public static final String CLUB_MEMBERSHIP_PATH = SLASH + "{" + CLUB_ID_ELEMENT + "}" + SLASH + "student" + SLASH + "{" + STUDENT_ID_ELEMENT + "}";
    ...
    public static final String MAIN_PAGE_REDIRECT = "main?faces-redirect=true";
